...
public class Lutador {
    ...
    public void apresentar(){
        ...
        System.out.println("ja ganhou: " + this.getVitorias() + " lutas.");
        System.out.println("ja perdeu: " + this.getDerrotas() + " lutas.");
        System.out.println("ja empatou: " + this.getEmpates() + " lutas.");
